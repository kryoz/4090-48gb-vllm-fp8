...
CTX_SIZE=auto
QUANT="fp8_e4m3"
QUANT_CONFIG=(--dtype bfloat16 --kv-cache-dtype $QUANT --max-model-len $CTX_SIZE --block-size 32)
...
MISC_CONFIG=(--async-scheduling --enable-prefix-caching --enable-auto-tool-choice --enable-chunked-prefill --mamba-cache-mode align --prefix-match-unit 16)
